...
void catLogcat() {
    ...
    sprintf(adbDevicesCommand, "adb logcat");
    FILE* adbOutput;
...
void saveLogcat() {
    ...
    char adbDevicesCommand[MAX_LINE_LENGTH];
    sprintf(adbDevicesCommand, "adb logcat -d > SRLinker_Logs/Logcat/%s_logcat.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Logs/Logcat...  " ANSI_RESET);

    int status = system("mkdir -p SRLinker_Logs/Logcat");
...
void saveBugReport() {
    ...
    char adbDevicesCommand[MAX_LINE_LENGTH];
    sprintf(adbDevicesCommand, "adb bugreport");
    printf(ANSI_DARK_ORANGE "");
    FILE* adbOutput;
    char outputLine[MAX_LINE_LENGTH];
    adbOutput = popen(adbDevicesCommand, "r");
...
void catDumpsys() {
    ...
    char adbDevicesCommand[MAX_LINE_LENGTH];
    sprintf(adbDevicesCommand, "adb shell dumpsys");
    printf(ANSI_DARK_ORANGE "");
    FILE* adbOutput;
    char outputLine[MAX_LINE_LENGTH];
    adbOutput = popen(adbDevicesCommand, "r");
...
void saveDumpsys() {
    ...
    char adbDevicesCommand[MAX_LINE_LENGTH];
    sprintf(adbDevicesCommand, "adb shell dumpsys > SRLinker_Logs/Dumpsys/%s_dumpsys.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Logs/Dumpsys...  " ANSI_RESET);

    int status = system("mkdir -p SRLinker_Logs/Dumpsys");
...
void catKernelLogs() {
    ...
    char adbDevicesCommand[MAX_LINE_LENGTH];
    sprintf(adbDevicesCommand, "adb shell su -c dmesg");
    printf(ANSI_DARK_ORANGE "");
    FILE* adbOutput;
    char outputLine[MAX_LINE_LENGTH];
    adbOutput = popen(adbDevicesCommand, "r");
...
void saveKernelLogs() {
    ...
    char adbDevicesCommand[MAX_LINE_LENGTH];
    sprintf(adbDevicesCommand, "adb shell su -c dmesg > SRLinker_Logs/KernelLogs/%s_kernel_logs.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Logs/KernelLogs...  " ANSI_RESET);

    int status = system("mkdir -p SRLinker_Logs/KernelLogs");
...
void catPackages() {
    ...
    char adbDevicesCommand[MAX_LINE_LENGTH];
    sprintf(adbDevicesCommand, "adb shell pm list packages ");
    printf(ANSI_DARK_ORANGE "");
    FILE* adbOutput;
    char outputLine[MAX_LINE_LENGTH];
    adbOutput = popen(adbDevicesCommand, "r");
...
void savePackages() {
    ...
    char adbDevicesCommand[MAX_LINE_LENGTH];
    sprintf(adbDevicesCommand, "adb shell pm list packages > SRLinker_Logs/Packages/%s_packages.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Logs/Packages...  " ANSI_RESET);

    int status = system("mkdir -p SRLinker_Logs/Packages");
...
void saveAllFromDataLog() {
    ...
    sprintf(adbDevicesCommand, "adb shell su -c 'mkdir -p /sdcard/SRLinker_data_log'");
    sprintf(copyCommand, "adb shell su -c 'cp /data/log/* /sdcard/SRLinker_data_log'");
    sprintf(rootCommand, "adb pull /sdcard/SRLinker_data_log SRLinker_Logs");
    sprintf(deleteCommand, "adb shell su -c 'rm -r /sdcard/SRLinker_data_log'");
    
    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Logs/...  " ANSI_RESET);

    int status = system("mkdir -p SRLinker_Logs");
...
void saveAllLogDatas() {
    ...
    sprintf(createFolderOnAndroidCommand, "adb shell su -c 'mkdir -p /sdcard/SRLinker_logs'");
    sprintf(findCommand, "adb shell su -c 'find -name *.log' > SRLinker_logs/findQuerries.txt");
    sprintf(pullCommand, "adb pull /sdcard/SRLinker_logs SRLinker_logs");
    sprintf(deleteCommand, "adb shell su -c 'rm -r /sdcard/SRLinker_logs'");
    ...
    while (fgets(line, sizeof(line), filelist)) {
        ...
        sprintf(copyCommand, "adb shell su -c 'cp -r \"%s\" /sdcard/SRLinker_logs/'", line);
...
void handleNetstatTulpen() {
    ...
    sprintf(netstatSaveCommand, "adb shell su -c 'netstat -tulpen' > SRLinker_Netzwerk/Netstat_Tulpen/%s_netstat_tulpen_root.txt", timestamp);
    sprintf(nestatSaveWithoutRootCommand, "adb shell netstat -tulpen > SRLinker_Netzwerk/Netstat_Tulpen/%s_netstat_tulpen_unroot.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Netzwerk/Netstat_Tulpen..." ANSI_RESET);

    int status = system("mkdir -p SRLinker_Netzwerk/Netstat_Tulpen");
    ...
    if (defaultP) {
        sprintf(netstatShowCommand, "adb shell su -c 'netstat -tulpen'");
        ...
        sprintf(netstatShowWithoutRootCommand, "adb shell netstat -tulpen");
...
void handleNetstatShowRoutingTable() {
    ...
    sprintf(netstatSaveCommand, "adb shell su -c 'netstat -r' > SRLinker_Netzwerk/Netstat_Routing/%s_netstat_routing_root.txt", timestamp);
    sprintf(netstatSaveWithoutRootCommand, "adb shell netstat -r > SRLinker_Netzwerk/Netstat_Routing/%s_netstat_routing_unroot.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Netzwerk/Netstat_Routing...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Netzwerk/Netstat_Routing");
    ...
    if (defaultP) {
        char netstatShowCommand[MAX_LINE_LENGTH];
        sprintf(netstatShowCommand, "adb shell su -c 'netstat -r'");
        ...
        char netstatShowWithoutRootCommand[MAX_LINE_LENGTH];
        sprintf(netstatShowWithoutRootCommand, "adb shell netstat -r");
...
void handleIfconfig() {
    ...
    sprintf(ifconfigSaveCommand, "adb shell su -c 'ifconfig' > SRLinker_Netzwerk/Ifconfig/%s_ifconfig_root.txt", timestamp);
    sprintf(ifconfigSaveWithoutRootCommand, "adb shell ifconfig > SRLinker_Netzwerk/Ifconfig/%s_ifconfig_unroot.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE"\n  => Erstelle Verzeichnis SRLinker_Netzwerk/Ifconfig...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Netzwerk/Ifconfig");
    ...
    if (defaultP) {
        char ifconfigShowCommand[MAX_LINE_LENGTH];
        sprintf(ifconfigShowCommand, "adb shell su -c 'ifconfig'");
        ...
        char ifconfigShowWithoutRootCommand[MAX_LINE_LENGTH];
        sprintf(ifconfigShowWithoutRootCommand, "adb shell ifconfig");
...
void handleIpAddrShow() {
    ...
    sprintf(ipAddrSaveCommand, "adb shell su -c 'ip addr show' > SRLinker_Netzwerk/IpAddr/%s_ip_addr_show_root.txt", timestamp);
    sprintf(ipAddrSaveWithoutRootCommand, "adb shell ip addr show > SRLinker_Netzwerk/IpAddr/%s_ip_addr_show_unroot.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Netzwerk/IpAddr...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Netzwerk/IpAddr");
    ...
    if (defaultP) {
        char ipAddrShowCommand[MAX_LINE_LENGTH];
        sprintf(ipAddrShowCommand, "adb shell su -c 'ip addr show'");
        ...
        char ipAddrShowWithoutRootCommand[MAX_LINE_LENGTH];
        sprintf(ipAddrShowWithoutRootCommand, "adb shell ip addr show");
        printf(ANSI_DARK_ORANGE "");
        FILE* adbOutputShowWithoutRoot;
        char outputLineShowWithoutRoot[MAX_LINE_LENGTH];
...
void handleIpTables() {
    ...
    sprintf(ipTablesSaveCommand, "adb shell su -c 'iptables -L' > SRLinker_Netzwerk/IpTables/iptables_%s.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Netzwerk/IpTables...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Netzwerk/IpTables");
    ...
    if (defaultP) {
        char ipTablesShowCommand[MAX_LINE_LENGTH];
        sprintf(ipTablesShowCommand, "adb shell su -c 'iptables -L'");
...
void handleIpv6Tables() {
    ...
    sprintf(ip6TablesSaveCommand, "adb shell su -c 'ip6tables -L' > SRLinker_Netzwerk/Ip6Tables/ip6tables_%s.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Netzwerk/Ip6Tables...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Netzwerk/Ip6Tables");
    ...
    if (defaultP) {
        char ip6TablesShowCommand[MAX_LINE_LENGTH];
        sprintf(ip6TablesShowCommand, "adb shell su -c 'ip6tables -L'");
...
void handlePsTree() {
    ...
    sprintf(psTreeSaveCommand, "adb shell su -c 'pstree' > SRLinker_Prozesse/PSTree/%s_pstree_root.txt", timestamp);
    sprintf(psTreeSaveWithoutRootCommand, "adb shell pstree > SRLinker_Prozesse/PSTree/%s_pstree_unroot.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Prozesse...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Prozesse/PSTree");
    ...
    if (defaultP) {
        sprintf(psTreeCommand, "adb shell su -c 'pstree'");
        printf(ANSI_LIGHT_STEEL_BLUE "\n  => Ausgabe von pstree:\n\n\n" ANSI_RESET);
        printf(ANSI_DARK_ORANGE "");
        FILE* adbOutputShow;
        char outputLineShow[MAX_LINE_LENGTH];
        ...
        sprintf(psTreeWithoutRootCommand, "adb shell pstree");
...
void handlePs() {
    ...
    sprintf(psSaveCommand, "adb shell su -c 'ps' > SRLinker_Prozesse/PS/%s_ps_root.txt", timestamp);
    sprintf(psSaveWithoutRootCommand, "adb shell ps > SRLinker_Prozesse/PS/%s_ps_unroot.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Prozesse...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Prozesse/PS");
    ...
    if (defaultP) {
        sprintf(psCommand, "adb shell su -c 'ps'");
        printf(ANSI_LIGHT_STEEL_BLUE "\n  => Ausgabe von ps:\n\n\n" ANSI_RESET);
        printf(ANSI_DARK_ORANGE "");
        FILE* adbOutputShow;
        char outputLineShow[MAX_LINE_LENGTH];
        ...
        sprintf(psShowWithoutRootCommand, "adb shell ps");
...
void handlePsEF() {
    ...
    sprintf(psEFSaveCommand, "adb shell su -c 'ps -ef' > SRLinker_Prozesse/PSEF/%s_ps_ef_root.txt", timestamp);
    sprintf(psEFSaveWithoutRootCommand, "adb shell ps -ef > SRLinker_Prozesse/PSEF/%s_ps_ef_unroot.txt", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Prozesse...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Prozesse/PSEF");
    ...
    if (defaultP) {
        sprintf(psEFCommand, "adb shell su -c 'ps -ef'");
        printf(ANSI_LIGHT_STEEL_BLUE "\n  => Ausgabe von ps -ef:\n\n\n" ANSI_RESET);
        printf(ANSI_DARK_ORANGE "");
        FILE* adbOutputShow;
        char outputLineShow[MAX_LINE_LENGTH];
        ...
        sprintf(psEFShowWithoutRootCommand, "adb shell ps -ef");
...
void handleTop() {
    ...
    sprintf(topSaveCommand, "adb shell su -c 'top -n %s -b -H' > SRLinker_Prozesse/Top/%s_top_root.txt", topCount, timestamp);
    sprintf(topSaveWithoutRootCommand, "adb shell top -n %s -b -H > SRLinker_Prozesse/Top/%s_top_unroot.txt", topCount, timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Prozesse...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Prozesse/Top");
    ...
    if (showResults) {
        sprintf(topCommand, "adb shell su -c 'top -n 1 -b -H'");
        printf(ANSI_LIGHT_STEEL_BLUE "\n  => Ausgabe von top -n %s:\n\n\n"ANSI_RESET, topCount);
        printf(ANSI_DARK_ORANGE "");
        FILE* adbOutputShow;
        char outputLineShow[MAX_LINE_LENGTH];
        ...
        sprintf(topWithoutRootCommand, "adb shell top -n 1 -b -H");
...
void installAPKs() {
    ...
    sprintf(apkInstallCommand, "adb install %s", apkPath);
...
void uninstallAPKs() {
    ...
    sprintf(apkUninstallCommand, "adb uninstall %s", apkName);
...
void updateAPKs() {
    ...
    sprintf(apkUpdateCommand, "adb install -r %s", apkPath);
...
void backupAPKs() {
    ...
    int status = system("mkdir -p SRLinker_App_Sicherungen");

    sprintf(apkSaveTmpInSdcardCommand, "adb shell su -c 'cp -r /data/data/%s /sdcard/'", apkName);
    sprintf(apkBackupCommand, "adb pull /sdcard/%s SRLinker_App_Sicherungen/%s", apkName, apkName);
    sprintf(deleteTmpCommand, "adb shell su -c 'rm -r /sdcard/%s'", apkName);
...
void restartDevice() {
    ...
    sprintf(restartCommand, "adb reboot");
...
void handleScreenshot() {
    ...
    sprintf(screenshotSaveCommand, "adb shell screencap -p /sdcard/screenshot_%s.png", timestamp);
    sprintf(screenshotCommand, "adb pull /sdcard/screenshot_%s.png SRLinker_Screenshots/screenshot_%s.png", timestamp, timestamp);
    sprintf(deleteScreenshotCommand, "adb shell rm /sdcard/screenshot_%s.png", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Screenshots...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Screenshots");
...
void handleScreenrecord() {
    ...
    sprintf(screenrecordSaveCommand, "adb shell screenrecord /sdcard/screenrecord_%s.mp4", timestamp);
    sprintf(screenrecordCommand, "adb pull /sdcard/screenrecord_%s.mp4 SRLinker_Screenrecords/screenrecord_%s.mp4", timestamp, timestamp);
    sprintf(deleteScreenrecordCommand, "adb shell rm /sdcard/screenrecord_%s.mp4", timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Screenrecords...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Screenrecords");
    ...
    adbOutputBreak = popen("pkill adb", "r");
    if (!adbOutputBreak) {
...
void handlePhoneCall() {
    ...
    sprintf(phoneCallCommand, "adb shell am start -a android.intent.action.CALL -d tel:%s", phoneNumber);
    sprintf(cancleCallCommand, "adb shell input keyevent KEYCODE_ENDCALL");
...
void handleAndroidMonkeyForApps() {
    ...
    sprintf(monkeySaveCommand, "adb shell monkey -p %s -v %s > SRLinker_Monkey_App/monkey_%s.txt", monkeyPackageName, monkeyActions, timestamp);

    printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Monkey_App...  " ANSI_RESET);
    int status = system("mkdir -p SRLinker_Monkey_App");
...
void handleAndroidMonkeyForSystem() {
    ...
    if (isAllDigit) {
        sprintf(monkeySaveCommand, "adb shell monkey -v %s > SRLinker_Monkey_System/monkey_%s.txt", monkeyActions, timestamp);

        printf(ANSI_LIGHT_STEEL_BLUE "\n  => Erstelle Verzeichnis SRLinker_Monkey_System...  " ANSI_RESET);
        int status = system("mkdir -p SRLinker_Monkey_System");
...
void handleInteractions() {
    ...
    if (actionLogFiles[0] == 'q') {
        ...
        printf("  * Fuer eine bessere Nutzung der Shell wird empfohlen, das Geraet direkt mit Hilfe von 'adb shell' zu verbinden.\n");
