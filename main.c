...
void initialExpenses()
{
    ...
    printf(ANSI_BOLD "\n  Die Verwendung von SRLinker unter Linux vordert ADB!" ANSI_RESET_BOLD);
    printf("\n---------------------------------------------------------------\n\n");

    printf(ANSI_LIGHT_STEEL_BLUE "  Info: Um die ADB (Android Debug Bridge) unter Linux zu installieren, kann der folgende Terminal-Befehl ausgeführt werden: \n\n  => sudo apt-get install android-tools-adb  \n\n\n"ANSI_RESET);
    printf(ANSI_DARK_ORANGE "  [a]" ANSI_RESET " Starten\n");
